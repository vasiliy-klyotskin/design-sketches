...
/// Используется для построения разницы виджет-деревьев.
struct WidgetId {
    ...
    /// Идентификатор состояния виджета. По нему мы понимаем, когда мы хотим обновить данные для определенного виджета
